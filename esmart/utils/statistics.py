...
def increment_stat(logger, stats_csv, stat, amount):
    """
...
def recreate_stat_file(id_file, stats_csv, stats_interval, esmart_version):
    """
    ...
    new_stat_data = [['stat', 'value'],
                     ...
                     ['eSmart_revision', esmart_version],
                     ['country', 'None'],
...
def send_stats(logger, host, port, user, password, dbname,
               esmart_db_path, user_db_path, stats_csv, esmart_version,
    ...
    try:
        ...
        add_update_csv(logger, stats_csv, 'eSmart_revision', esmart_version)
