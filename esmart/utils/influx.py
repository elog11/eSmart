...
def read_last_influxdb(host, port, user, password,
    ...
    example:
        read_last_influxdb('localhost', 8086, 'esmart', 'password123',
                           'esmart_db', '00000001', 'temperature')
...
def read_duration_influxdb(host, port, user, password, dbname,
    ...
    example:
        read_last_influxdb('localhost', 8086, 'esmart', 'password123',
                           'esmart_db', '00000001', 'temperature', 10)
...
def write_influxdb(logger, host, port, user, password,
    ...
    example:
        write_influxdb('localhost', 8086, 'esmart', 'password123',
                       'esmart_db', '00000001', 'temperature', 37.5)
...
def write_influxdb_list(logger, host, port, user, password,
    ...
    example:
        write_influxdb('localhost', 8086, 'esmart', 'password123',
                       'esmart_db', data_list_of_dictionaries)
